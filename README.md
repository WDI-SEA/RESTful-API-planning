...
| HTTP METHOD (_Verb_) | URL (_Nouns_) | CRUD    | Response                     | Notes                                      |
| -------------------- | ------------- | ------- | ---------------------------- | ------------------------------------------ |
| GET                  | BOOKS         | READ    | /BOOKS                       | array of books                             |
| GET                  | MEMBERS       | READ    | /MEMBERS                     | array of members                           |
| GET                  | GENRES        | READ    | /GENRES                      | array of genres                            |
| POST                 | BOOKS         | CREATE  | /BOOKS                       | Create book                                |
| PUT                  | BOOKS         | UPDATE  | /BOOKS/:ID                   | update book info at :id                    |
| DELETE               | BOOKS         | DESTROY | /BOOKS/:ID                   | destroy book at :id                        |
| POST                 | GENRES        | CREATE  | /GENRES                      | create genre                               |
| PUT                  | GENRES        | UPDATE  | /GENRES/:ID                  | update genre at :id                        |
| POST                 | MEMBERS       | CREATE  | /MEMBERS                     | create member                              |
| PUT                  | MEMBERS       | UPDATE  | /MEMBERS/:ID                 | update member at :id                       |
| DELETE               | MEMBERS       | DESTROY | /MEMBERS/:ID                 | destroy member at :id                      |
| DELETE               | GENRES        | DESTROY | /MEMBERS/:ID                 | destroy genre at :id                       |
| PUT                  | MEMBERS       | UPDATE  | /MEMBERS/:ID/BOOKS/:BOOKID   | Update specific book to specific member    |
| DELETE               | BOOKS         | UPDATE  | /BOOKS/:ID/MEMBERS/:MEMBERID | DELETE specific book at specific member ID |
