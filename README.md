...
| HTTP METHOD (_Verb_) | URL (_Nouns_)                                   | CRUD  | Response                              | Notes |
| -------------------- | ---------------------------------- | ----  | ------------------------------------- | ----- |
| GET                  |  /members                                       | GET   | Array of members [{ member},{member }]|       |
| GET                  |  /members/:id                                   | GET   | Single member { member }              |       |
| POST                 |  /members                                       |CREATE | No Data or new member { member }      |       |
| PUT/PATCH            |  /members/:id                                   |UPDATE | No Data or updated member { member }  |       |
| DELETE               |  /members/:id                                   |DESTROY| No data                               |       |
| GET                  |  /books                                         | GET   | Array of books [{book},{book}]        |       |
| GET                  |  /books/:id                                     | GET   | Single member {book}                  |       |
| POST                 |  /books                                         |CREATE | No Data or new book { book }          |       |
| PUT/PATCH            |  /books/:id                                     |UPDATE | No Data or updated book { book }      |       |
| DELETE               |  /books/:id                                     |DESTROY| No data                               |       |
| GET                  |  /genres                                        | GET   | Array of books [{genres},{genres}]    |       |
| GET                  |  /genres/:id                                    | GET   | Single member {genres}                |       |
| POST                 |  /genres                                        |CREATE | No Data or new book { genres }        |       |
| PUT/PATCH            |  /genres/:id                                    |UPDATE | No Data or updated book { genres }    |       |
| DELETE               |  /genres/:id                                    |DESTROY| No data                               |       |
| GET                  |  /members/:user_id/books/:book_id/books_genres  |       |                                       |       |
| GET                  |  /books_genres/:id                              | GET   | Array of books [{genres},{genres}]    |       |
| GET                  |  /books_genres/:id                              | GET   | Single member {genres}                |       |
| POST                 |  /books_genres/:id                              |CREATE | No Data or new book { genres }        |       |
| PUT/PATCH            |  /books_genres/:id                              |UPDATE | No Data or updated book { genres }    |       |
