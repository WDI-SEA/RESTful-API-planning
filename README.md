...
| HTTP METHOD (_Verb_) | URL (_Nouns_)        | CRUD   | Response                         | Notes                           |
| -------------------- | -------------------- | ------ | -------------------------------- | ------------------------------- |
| POST                 | /member              | CREATE | No data or new member { member } | Create a new member             |
| GET                  | /member/:id          | READ   |                                  | Read members info               |
| DELETE               | /member/:id          | DELETE |                                  | Delete members info             |
| PUT                  | /member/:id          | UPDATE |                                  | update members info             |
| GET                  | /books               | READ   |                                  | See all books                   |
| GET                  | /books/:id           | READ   |                                  | Find a particular book          |
| DELETE               | /books/:id           | DELETE |                                  | Delete book from DB             |
| PUT                  | /books/:id           | UPDATE |                                  | Update book status c/o or c/i   |
| POST                 | /books/:id           | CREATE |                                  | Add new book to library         |
| POST                 | /books/:id/:genre_id | CREATE |                                  | Add a book to a genre           |
| DELETE               | /books/:id/:genre_id | DELETE |                                  | Remove genre from book          |
| GET                  | /books/:id/genre     | READ   |                                  | All genres tied to a book       |
| GET                  | /genre/              | READ   |                                  | See all genres                  |
| GET                  | /genre/:id           | READ   |                                  | All books in a genre            |
| PUT                  | /member/:id/:book_id | UPDATE |                                  | Update books c/i and c/o status |
